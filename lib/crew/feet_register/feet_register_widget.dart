...
class FeetRegisterWidget extends StatefulWidget {
  const FeetRegisterWidget({super.key});

  @override
  State<FeetRegisterWidget> createState() => _FeetRegisterWidgetState();
}

class _FeetRegisterWidgetState extends State<FeetRegisterWidget> {
  late FeetRegisterModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FeetRegisterModel());
