...
class CreateFeetWidget extends StatefulWidget {
  const CreateFeetWidget({super.key});

  @override
  State<CreateFeetWidget> createState() => _CreateFeetWidgetState();
}

class _CreateFeetWidgetState extends State<CreateFeetWidget> {
  late CreateFeetModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateFeetModel());
