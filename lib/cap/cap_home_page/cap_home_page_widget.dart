...
class CapHomePageWidget extends StatefulWidget {
  const CapHomePageWidget({super.key});

  @override
  State<CapHomePageWidget> createState() => _CapHomePageWidgetState();
}

class _CapHomePageWidgetState extends State<CapHomePageWidget>
    with TickerProviderStateMixin {
  late CapHomePageModel _model;
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                          fit: BoxFit.cover,
                          image: Image.network(
                            'https://images.unsplash.com/photo-1616712134411-6b6ae89bc3ba?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHw2fHxzdGFycnklMjBuaWdodHxlbnwwfHx8fDE3MTg1ODEwNDJ8MA&ixlib=rb-4.0.3&q=80&w=1080',
                          ).image,
                        ),
                        borderRadius: BorderRadius.circular(12.0),
                      ),
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  context.pushNamed('ParticipationRequestlist');
                                },
                                text: 'Explore Now',
                ...
                Lottie.asset(
                  'assets/lottie_animations/suntar.json',
                  width: 393.0,
                  height: 130.0,
                  fit: BoxFit.cover,
                  animate: true,
