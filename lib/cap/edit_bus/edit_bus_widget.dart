...
import 'edit_bus_model.dart';
export 'edit_bus_model.dart';

class EditBusWidget extends StatefulWidget {
  const EditBusWidget({super.key});

  @override
  State<EditBusWidget> createState() => _EditBusWidgetState();
}

class _EditBusWidgetState extends State<EditBusWidget> {
  late EditBusModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditBusModel());
