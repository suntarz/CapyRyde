...
class CrewMemberWidget extends StatefulWidget {
  const CrewMemberWidget({super.key});

  @override
  State<CrewMemberWidget> createState() => _CrewMemberWidgetState();
}

class _CrewMemberWidgetState extends State<CrewMemberWidget> {
  late CrewMemberModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CrewMemberModel());
  }
